...
import WelderData from "@/data/Welder.json";

function WelderPage() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36">
      <h1 className="text-4xl md:text-7xl text-center font-sans font-bold mb-8 text-white">
        Welder ({WelderData.Welder.length})
      </h1>
      <div className="flex flex-wrap justify-center">
        {WelderData.Welder.map((Welder) => (
          <CardContainer className="inter-var m-4" key={Welder.id}>
                ...
                >
                  ...
                  >
                    <text className=" text-lg text-gray-400">
                      Experience: {Welder.experience} years
                    </text>
                  </CardItem>
                  <CardItem
                    as="p"
