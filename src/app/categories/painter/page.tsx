...
import PainterData from "@/data/Painter.json";

function PainterPage() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36">
      <h1 className="text-4xl md:text-7xl text-center font-sans font-bold mb-8 text-white">
        Painter ({PainterData.Painter.length})
      </h1>
      <div className="flex flex-wrap justify-center">
        {PainterData.Painter.map((Painter) => (
          <CardContainer className="inter-var m-4" key={Painter.id}>
                ...
                >
                  ...
                  >
                    <text className=" text-lg text-gray-400">
                      Experience: {Painter.experience} years
                    </text>
                  </CardItem>
                  <CardItem
                    as="p"
