  ...
  return (
    <div className="min-h-screen bg-black py-12 pt-36">
      <h1 className="text-4xl md:text-7xl text-center font-sans font-bold mb-8 text-white">
        Household ({HouseholdData.Household.length})
      </h1>
      <div className="flex flex-wrap justify-center">
        {HouseholdData.Household.map((Household) => (
          <CardContainer className="inter-var m-4" key={Household.id}>
                ...
                >
                  ...
                  >
                    <text className=" text-lg text-gray-400">
                      Experience: {Household.experience} years
                    </text>
                  </CardItem>
                  <CardItem
                    as="p"
